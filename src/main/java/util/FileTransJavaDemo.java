...
public class FileTransJavaDemo {
    ...
    public static final String API_VERSION = "2021-04-14";
    ...
    public static void main() throws Exception {
        final String accessKeyId = "填写accessKeyId";
        final String accessKeySecret = "填写accessKeySercet";
        final String appKey = "填写appKey";
        String fileLink = "文件地址";
        ...
        if (result != null) {
            ...
            Watcher watcher = JSONObject.parseObject(result, Watcher.class);
//            watcher.getWords().stream().reduce(new java.util.ArrayList<String>().stream(),
//                    (a, b) -> Stream.concat(Stream.of(b.getWord())), Stream::concat
//            );
